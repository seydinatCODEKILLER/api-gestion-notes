...
import StatistiqueRoute from "./routes/StatistiqueRoutes.js";
...
const statisticsRoute = new StatistiqueRoute();
...
app.route("/api/statistic", statisticsRoute.routes);
app.route("/api/evaluations", evaluationRoute.routes);
